...
<body>
  ...
  Please<a href="${fullPrescribingInfoLink}" target="_blank" rel="noopener noreferrer"> click here</a> to access the full <a href="${fullPrescribingInfoLink}" target="_blank" rel="noopener noreferrer"> <strong>Prescribing Information.</strong></a>
